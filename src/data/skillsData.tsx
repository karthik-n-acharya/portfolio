        ...
        icon: (
          ...
          >
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset=".003" stop-color="#a33094" />
              <stop offset=".998" stop-color="#6d246b" />
            </linearGradient>
            <path
              fill="url(#V-oMXmZmTVsp9erTs5L2ta)"
              d="M20.5,46c-0.567,0-1.107-0.24-1.487-0.662L1.917,26.342c-0.58-0.645-0.898-1.477-0.898-2.343	s0.319-1.697,0.899-2.342L19.013,2.662c0.759-0.844,2.215-0.844,2.974,0l17.097,18.996c0,0,0,0,0,0.001c1.2,1.334,1.2,3.348,0,4.682	L21.987,45.338C21.607,45.76,21.067,46,20.5,46z"
            />
            <path
              d="M39.98,24c0,0.84-0.3,1.68-0.9,2.34L23.66,43.49l-0.34,0.37l-6.05-6.72c-1.03-1.15-1.03-2.87,0-4.02	l7.37-8.19c0.48-0.53,0.48-1.33,0-1.86l-7.37-8.19c-1.03-1.15-1.03-2.87,0-4.02l6.05-6.72l0.34,0.37l15.42,17.15	C39.68,22.32,39.98,23.16,39.98,24z"
              opacity=".05"
            />
            <path
              d="M39.98,24c0,0.84-0.3,1.68-0.9,2.34L23.66,43.49l-6.02-6.69c-0.86-0.95-0.86-2.39,0-3.34l7.37-8.19	c0.65-0.73,0.65-1.81,0-2.54l-7.37-8.19c-0.86-0.95-0.86-2.39,0-3.34l6.02-6.69l15.42,17.15C39.68,22.32,39.98,23.16,39.98,24z"
              opacity=".05"
            />
            <linearGradient
              id="V-oMXmZmTVsp9erTs5L2tb"
              x1="27.385"
              x2="34.916"
              y1="2.013"
              y2="44.72"
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset=".006" stop-color="#e9a0cb" />
              <stop offset=".998" stop-color="#e48dc7" />
            </linearGradient>
            <path
              fill="url(#V-oMXmZmTVsp9erTs5L2tc)"
              d="M37.991,34.323	c-0.567,0-1.107-0.24-1.486-0.662l-6.588-7.319c-0.581-0.646-0.9-1.479-0.899-2.346c0-0.865,0.32-1.695,0.899-2.339l6.587-7.318	c0.758-0.844,2.215-0.844,2.973,0l6.588,7.319c1.2,1.336,1.2,3.348,0.001,4.683l-6.589,7.32	C39.099,34.083,38.558,34.323,37.991,34.323z"
            />
          </svg>
        ),
      },
