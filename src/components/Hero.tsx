    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            Driven by a passion for web development, I create dynamic,
            responsive, and visually captivating web applications that
            prioritize user experience, performance, and modern design
            principles.
          </motion.p>
